...
OMCONVERT_SCRIPT_LOCATION = os.path.join(os.path.dirname(os.path.abspath(__file__)), "raw_data_conversion",
                                         "omconvert", "omconvert")
TIMESYNC_LOCATION = os.path.join(os.path.dirname(os.path.abspath(__file__)), "raw_data_conversion",
                                 "timesync3", "timesync3")
